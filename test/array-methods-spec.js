...
describe('Array Methods', function() {
  ...
  describe('sumOfHighInterests', function() {
    it('should be the sum the 18.9% interest for all amounts in bankBalances except for the states listed, where the amount of the sum of interests in that state is greater than 50,000, rounded to the nearest cent', function() {
